...
const WorkSpace2 = ({ hideSourceOnDrag }) => {
    ...
    return (
        ...
        <div className="workspace3__header">
            ...
            {images.length > 0 ? images.map((imageUrl, index) => (
                    ...
                    <>
                        <div className="workspace2__panel" ref={drop1}>
                        ...
                        <div className="workspace2__panel" ref={drop2}>
                        ...
                        <div className="workspace2__panel" ref={drop3}>
                        ...
                        <div className="workspace2__panel" ref={drop4}>
                        ...
                        <div className="workspace2__panel" ref={drop5}>
                        ...
                        <div className="workspace2__panel" ref={drop6}>
                        ...
                        <div className="workspace2__panel" ref={drop7}>
                        ...
                        <div className="workspace2__panel" ref={drop8}>
                        ...
                        <div className="workspace2__panel" ref={drop9}>
                        ...
                        <div className="workspace2__panel" ref={drop10}>
