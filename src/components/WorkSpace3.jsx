...
const WorkSpace3 = ({ hideSourceOnDrag }) => {
    ...
    const addBox1 = () => {
        ...
        const newBox = { top: 200, left: 200, title: "Write your dialog..." };
    ...
    return (
        <div className="workspace3__container__wrapper">
            ...
            <div className="workspace3__wrapper">
                {images.length > 0 ? images.map((imageUrl, index) => (
                    <div
                        key={index}
                        className={index === 0 ? 'news-item hero-item' : 'news-item standard-item'}
                    ...
                    <>
                        <div className="news-item hero-item" ref={drop1}>
                        ...
                        <div className="news-item standard-item" ref={drop2}>
                        ...
                        <div className="news-item standard-item" ref={drop3}>
                        ...
                        <div className="news-item standard-item" ref={drop4}>
                        ...
                        <div className="news-item standard-item" ref={drop5}>
                        ...
                        <div className="news-item standard-item" ref={drop6}>
                        ...
                        <div className="news-item standard-item" ref={drop7}>
                        ...
                        <div className="news-item standard-item" ref={drop8}>
                        ...
                        <div className="news-item standard-item" ref={drop9}>
                        ...
                        <div className="news-item standard-item" ref={drop10}>
